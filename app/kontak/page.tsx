...
const contactItems = [
  {
    icon: 'location_on',
    label: 'Alamat',
    value: 'Bekasi Grand Center Blok F1, Jl Cut Meutiah, RT.001/RW.011, Margahayu, Bekasi Timur, Bekasi, West Java 17113',
  },
  {
    icon: 'schedule',
    label: 'Jadwal Ibadah',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-12">
            <header className="space-y-4">
              ...
              <p className="text-xl text-secondary max-w-md leading-relaxed font-body">
                Punya pertanyaan tentang komunitas kami atau sekadar ingin menyapa? Kami di sini
                untuk mendengarkan.
              </p>
            </header>
              ...
              {contactItems.map((item) => (
                <div key={item.label} className="flex items-start gap-6 group">
                  ...
                  <div>
                    ...
                    <div className="text-on-surface font-body leading-relaxed">{item.value}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="pt-4">
              <p className="text-secondary font-body text-sm mb-4">
                Untuk bergabung ke komunitas atau tim pelayanan, hubungi kami langsung via WhatsApp:
              </p>
              <a
                href="#"
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="bg-surface-container-low rounded-xl p-8 border-l-4 border-primary-container">
              <h3 className="font-headline italic text-2xl text-on-surface mb-4">GSRI Jemaat Bekasi</h3>
              <p className="text-on-surface-variant text-sm leading-relaxed mb-4">
                Bekasi Grand Center Blok F1, Jl Cut Meutiah, RT.001/RW.011, Margahayu, Bekasi Timur,
